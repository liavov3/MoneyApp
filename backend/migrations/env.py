"""Alembic environment — async engine, metadata wired to app models.

The DSN comes from the application settings (DATABASE_URL env var), never from
alembic.ini, so credentials are externalized.
"""
